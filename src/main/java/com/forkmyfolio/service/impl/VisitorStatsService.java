...
public class VisitorStatsService {
    ...
    private static final String VCARD_DOWNLOAD_REF_ID = "vcard_download"; // <-- ADDED
    ...
    public void incrementVcardDownload() {
        log.debug("Incrementing vCard download count.");
        incrementStat(VisitorStatType.VCARD_DOWNLOAD, VCARD_DOWNLOAD_REF_ID);
    }
    ...
    public AdminStatsDto getStats() {
        ...
        long vcardDownloads = getSumForStatType(groupedStats, VisitorStatType.VCARD_DOWNLOAD); // <-- ADDED
        ...
        dto.setVcardDownloads(vcardDownloads); // <-- ADDED
